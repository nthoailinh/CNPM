...
public class MacCOVID {
    ...
    public MacCOVID(int id, String hoTen, String ngayMac, String ngayKhoi, String tinhTrangSK, String ketQuaTest, String hinhThucTest, String thoiDiemTest, String ngayKhaiBao) {
        this.id = id;
        this.hoTen = hoTen;
