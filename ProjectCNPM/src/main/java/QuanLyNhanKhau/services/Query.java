...
public class Query {
    ...
    public PreparedStatement KhaiBao(int idMacCOVID, String ngayKhaiBao, String thoiDiemTest, String hinhThucTest,
    ...
    public PreparedStatement MacCOVID(int idNguoiMac, String ngayMac) throws SQLException {
